	...
	<div id="wrap">
		...
		<main>
			...
			<div id="form-area">
				...
				<div><input type="password" name="pwd2" placeholder="패스워드 확인"></div>
				<div><input type="text" name="nick" placeholder="닉네임"></div>
				<div>프로필사진 : <input type="file" name="profile"></div>
				<div>
					<span>취미 (다중선택가능) : </span>
					<label>코딩
					...
					<label>게임
						<input type="checkbox" name="hobby" value="30">
					</label>
					<label>운동
						<input type="checkbox" name="hobby" value="40">
					</label>
					<label>요리
						<input type="checkbox" name="hobby" value="50">
					</label>
				</div>
				<div>
...
function checkDup(){
	...
	//4.결과에 따라 ,submit이 가능 또는 불가능 하게 만들기
